...
name: Serverless Azure OpenAI Assistant Quick Start with Function Calling
description: Azure OpenAI Assistants allows you to create AI assistants tailored to your needs through custom instructions and augmented by advanced tools like code interpreter, and custom functions. In this article, we provide an in-depth walkthrough of getting started with the Assistants API.
---
...
[Overview](#overview) • [Get started](#get-started) • [Run the sample](#run-the-sample) • [Resources](#resources)
  ...
  <img src="./azure-openai-assistant-demo.png" alt="Screenshot showing the assistant app in action" width="640px" />
